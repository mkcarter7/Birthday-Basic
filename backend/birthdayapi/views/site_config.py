...
class SiteConfigSerializer(serializers.ModelSerializer):
    ...
    party_end_time = serializers.DateTimeField(source='party.end_time', read_only=True)
    party_location = serializers.CharField(source='party.location', read_only=True)
    party_latitude = serializers.DecimalField(source='party.latitude', max_digits=9, decimal_places=6, read_only=True)
    party_longitude = serializers.DecimalField(source='party.longitude', max_digits=9, decimal_places=6, read_only=True)
